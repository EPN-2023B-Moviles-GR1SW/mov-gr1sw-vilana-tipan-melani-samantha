...
class BListViewAutomovil : AppCompatActivity() {
    ...
    var idTienda = 0
    var listaAutomovilesSQL: ArrayList<BAutomoviles> = arrayListOf<BAutomoviles>()
        ...
        registerForActivityResult(
            ...
            if(result.resultCode == Activity.RESULT_OK){
                if(result.data != null){
                    ...
                    EBaseDeDatos.tablaTiendaAutomovil.actualizarAutomovilFormulario(
                        data?.getStringExtra("marcaModificada").toString(),
    ...
    fun actualizarListView(){
        this.listaAutomovilesSQL = EBaseDeDatos
            .tablaTiendaAutomovil.consultarAutomovilesPorTienda(this.idTienda)
    ...
    fun abrirActividadConParametrosEditarA(clase: Class<*>){
        ...
        val automovil = listaAutomovilesSQL?.get(idItemSeleccionado)
    ...
    fun abrirDialogoEliminar(){
        ...
        builder.setPositiveButton("Aceptar"){ dialog, which ->
            EBaseDeDatos.tablaTiendaAutomovil.eliminarAutomovilFormulario(
                listaAutomovilesSQL?.get(idItemSeleccionado)!!.id?:0
            )
            actualizarListView() }
