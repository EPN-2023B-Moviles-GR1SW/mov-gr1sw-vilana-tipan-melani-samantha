...
fun main() {
    ...
    val inmutable: String = "Samantha";
    //inmutable = "Melani";

    //Mutables (Re asignar)
    var mutable: String = "Melani";
    mutable = "Samantha";
    ...
    //Variable primitiva
    val nombreProfesor: String = "Samantha Vilaña"
    ...
    sumaCuatro.sumar()
    println(Suma.pi)
    //println(Suma.elevalAlCuadrado(2))
    ...
    //iterar el arreglo y guarda el valor acumulado
...
class Suma( //Constructor Primario Suma
    ...
    //un companion object por clase con una o varias propiedades
    companion object {
        //Atributos y Metodos *Compartidos*
        //entre las instancias
        val pi = 3.14

        fun historialSumas(num:Int):Int {
            return num * num
        }
        //arreglo dinamico
