...
class IFirestore : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //EMPEZAR A PAGINAR
        val botonEmpezarAPaginar = findViewById<Button>(R.id.btn_fs_epaginar)
        botonEmpezarAPaginar.setOnClickListener {
            query = null;
    ...
    fun consultarCiudades(
        ...
        if(query == null){
            ...
            //consulta de la consulta anterior en el nuevo
            tarea = query!!.get()
        }
        if(tarea!= null){
            tarea
...
/*
    fun consultarIndiceCompuesto(
        ...
        citiesRefUnico
            ...
            .whereLessThanOrEqualTo("popultaion",4000000)
    ...
    fun consultarDocumento(
        ...
        //  .collection("direccion").document("E90-0011")
        //   .collection("nombre_collection_hijo").document("id_hijo)
...
private fun consultarIndiceCompuesto(
    ...
    fun crearDatosPrueba(){
        ...
        val data1 = hashMapOf(    "name" to "San Francisco",
            "state" to "CA",
            "country" to "USA",
            "capital" to false,
        ...
        val data2 = hashMapOf(    "name" to "Los Angeles",
            "state" to "CA",
            "country" to "USA",
            "capital" to false,
        ...
        val data3 = hashMapOf(    "name" to "Washington D.C.",
            "state" to null,    "country" to "USA",
            "capital" to true,    "population" to 680000,
            "regions" to listOf("east_coast"),)
        cities.document("DC").set(data3)
        val data4 = hashMapOf(    "name" to "Tokyo",
            "state" to null,
            "country" to "Japan",
            "capital" to true,
        ...
        val data5 = hashMapOf(    "name" to "Beijing",
            "state" to null,    "country" to "China",
            "capital" to true,    "population" to 21500000,
